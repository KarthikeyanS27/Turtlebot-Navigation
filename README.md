...
Example of path planning and speed control for adaptive-horizon MPC. Utilizes on-line computation to dynamically avoid obstacles while navigation towards goal/checkpoint location.  
