import numpy as np
import itertools
from functions_floorplan import *
import matplotlib.pyplot as plt
import matplotlib.animation as animation
from timeit import default_timer as timer
from floorplan.csvtoarray import *
...
while(goalReached==False): # run until goal is reached or while loop broken for other conditions
    ...
    new_obstacles = plotPath(robot_dim, robot_memory, scan_zone, x, y, dt, current_heading, goal, goalThresh, waypoints, wayPointThresh, obstacles, obstacle_radius, lines, lines_buffered, avoidance_radius, optimal_plot, active_plot, dim)
    ...
    if(goalReached==True):
        ...
        active_plot = 2
        robot_memory = len(x)
        plotPath(robot_dim, robot_memory, scan_zone, x, y, dt, current_heading, goal, goalThresh, waypoints, wayPointThresh, obstacles, obstacle_radius, lines, lines_buffered, avoidance_radius, optimal_plot, active_plot, dim)
        break
