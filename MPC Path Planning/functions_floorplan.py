...
def plotPath(robot_dim, robot_memory, scan_zone, x, y, dt, current_heading, goal, goalThresh, waypoints, wayPointThresh, obstacles, obstacle_radius, lines, lines_buffered, avoidance_radius, optimal_plot, active_plot, dim):
